...
namespace chef
{
    public partial class specials_Sort_Form : Form
    {
        sortRow[] sortRows = new sortRow[3];
        specials_Form parent_Form;

        public string sortDish
        {
            get
            {
                if (dishCheckBox.Checked)
                {
        ...
        public string sortDate
        {
            get
            {
                if (dateCheckBox.Checked)
                {
                    ...
                    {
                        return "special_date DESC, ";
                    }
                }
                return "";
            }
        }
        public specials_Sort_Form(specials_Form parent_Form)
        {
            InitializeComponent();
            sortRows[0] = new sortRow(dishCheckBox, dish1, dish2, true);
            sortRows[1] = new sortRow(priceCheckBox, price1, price2, true);
