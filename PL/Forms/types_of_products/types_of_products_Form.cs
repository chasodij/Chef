...
namespace chef
{
    public partial class types_of_products_Form : Form
    {
        ...
        {
            string order = "ORDER BY " + sort_Form.sortName + sort_Form.sortProteins + sort_Form.sortFats + sort_Form.sortCarbohydrates + sort_Form.sortEnergy;
            if (order == "ORDER BY ")
                return "";
